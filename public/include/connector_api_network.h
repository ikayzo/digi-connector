...
typedef enum {
    ...
    connector_request_id_network_open_stub	/**< Requesting callback to set up and simulate connection to Device Cloud */
...
typedef struct  {
    ...
    int socket;                             /**< File Descriptor to an application opened socket */
    int cert_status;                        /**< SSL certificate verification status */
